...
export function HeroSection() {
  ...
  return (
    <section className="bg-white pt-[68px]">
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 pt-14 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-end">
          <h1 className="text-[clamp(2.5rem,5vw,4rem)] font-bold text-ink leading-[1.1] tracking-tight">
      ...
      <div className="container-max px-4 sm:px-6 lg:px-8 pb-8">
        <div className="relative w-full h-[320px] sm:h-[420px] lg:h-[520px] rounded-3xl overflow-hidden bg-warm">
          <Image
          ...
          <div className="absolute bottom-6 left-6 text-white">
            <p className="font-semibold text-sm">Premium Listings</p>
            <p className="text-white/60 text-xs mt-0.5">Verified properties across Pakistan</p>
          </div>

          {/* Stat cards — bottom right */}
          <div className="absolute bottom-6 right-6 flex gap-3">
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 text-center shadow-card-lg">
              <p className="text-xl font-bold text-ink">200+</p>
              <p className="text-ink-400 text-xs mt-0.5">Listings</p>
            </div>
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 text-center shadow-card-lg">
              <p className="text-xl font-bold text-ink">500+</p>
              <p className="text-ink-400 text-xs mt-0.5">Clients</p>
            </div>
          </div>
        </div>
      </div>

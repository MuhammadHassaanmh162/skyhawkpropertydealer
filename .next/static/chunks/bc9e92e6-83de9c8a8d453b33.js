"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Bt:function(){return sE},ET:function(){return sy},IO:function(){return se},JU:function(){return iD},QT:function(){return sf},Xo:function(){return si},ad:function(){return iM},cf:function(){return sw},hJ:function(){return ib},oe:function(){return sg},r7:function(){return sp}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sf(e){e=iI(e,iN);let t=iI(e.firestore,iL);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iu({next:s=>{t.enqueueAndForget(()=>rO(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rB(e9(n.path),s,{includeMetadataChanges:!0,ra:!0});return rF(e,a)})(await ig(e),e.asyncQueue,t,n,r)),r.promise})(iV(t),e._key).then(n=>s_(t,e,n))}class sm extends sl{constructor(e){super(),this.firestore=e}convertBytes(e){return new iO(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iN(this.firestore,null,t)}}function sp(e,t,n,...r){e=iI(e,iN);let i=iI(e.firestore,iL),s=ij(i);return sv(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iP?function(e,t,n,r,i,s){let a=e.Fu(1,t,n),o=[i0(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i0(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i4(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Su(t);if(n instanceof iW)u.push(t);else{let e=iY(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iz(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Fu(1,t,n);iZ("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i2(t,e,n);r=(0,h.m9)(r);let l=i.Su(o);if(r instanceof iW)s.push(o);else{let e=iY(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iz(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tx.exists(!0))])}function sg(e){return sv(iI(e.firestore,iL),[new t$(e._key,tx.none())])}function sy(e,t){var n;let r=iI(e.firestore,iL),i=iD(e),s=(n=e.converter)?n.toFirestore(t):t;return sv(r,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Fu(s.merge||s.mergeFields?2:0,t,n,i);iZ("Data must be an object, but it was:",l,r);let u=iX(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i0(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i4(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new i$(new eM(u),a,o)})(ij(e.firestore),"addDoc",i._key,s,null!==e.converter,{}).toMutation(i._key,tx.exists(!1))]).then(()=>i)}function sw(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iR(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iR(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iN)a=iI(e.firestore,iL),o=e9(e._key.path),s={next:n=>{t[u]&&t[u](s_(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iI(e,iA);a=iI(n.firestore,iL),o=n._query;let r=new sm(a);s={next:e=>{t[u]&&t[u](new sd(a,r,n,e))},error:t[u+1],complete:t[u+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){let i=new iu(r),s=new rB(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rF(await ig(e),s)),()=>{i.$a(),e.asyncQueue.enqueueAndForget(async()=>rO(await ig(e),s))}}(iV(a),o,c,s)}function sv(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r0(await ip(e).then(e=>e.syncEngine),t,n)),n.promise}(iV(e),t)}function s_(e,t,n){let r=n.docs.get(t._key),i=new sm(e);return new sh(e,i,t._key,r,new su(n.hasPendingWrites,n.fromCache),t.converter)}function sE(){return new iH("serverTimestamp")}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iL(new D(t.getProvider("auth-internal")),new M(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ew(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.6.3",void 0),(0,o.KN)(m,"4.6.3","esm2017")}()}}]);